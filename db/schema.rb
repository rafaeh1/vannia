...
ActiveRecord::Schema.define(version: 2020_07_13_225823) do
  ...
  create_table "spree_paypal_express_checkouts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "token"
    t.string "payer_id"
